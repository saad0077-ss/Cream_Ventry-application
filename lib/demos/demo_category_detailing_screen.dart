...
//   // UPDATED: Improved image display widget
...
//       );
//     } else if (kIsWeb && category.imagePath.startsWith('data:image')) {
//       // Handle base64 images for web
//       try {
...
//   // UPDATED: Improved product image display widget
...
//         errorBuilder: (context, error, stackTrace) => _buildErrorIcon(),
//       );
//     } else if (kIsWeb && product.imagePath.startsWith('data:image')) {
//       // Handle base64 images for web
//       try {
...
//                           child: ClipRRect(
//                             borderRadius: BorderRadius.circular(12),
//                             child: _buildCategoryImage(widget.category),
//                           ),
//                         ),
